...
import { idlFactory } from './user_directory_manager.did.js';
export { idlFactory } from './user_directory_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.USER_DIRECTORY_MANAGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./user_directory_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the user_directory_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./user_directory_manager.did.js")._SERVICE>}
 */
export const user_directory_manager = createActor(canisterId);
